...
// interface ThirdhomeProps {}

// export default function Thirdhome(props: ThirdhomeProps) {
//   return (
//     <div className="relative w-full flex items-center justify-center px-4 py-20 bg-[#F6FFF7]">
//       {/* Border container */}
...
//         <div className="absolute top-[-10px] left-[-8px] w-4 h-4 bg-[#3CB371]" />
//         <div className="absolute top-[-10px] right-[-8px] w-4 h-4 bg-[#3CB371]" />
//         <div className="absolute bottom-[-10px] left-[-8px] w-4 h-4 bg-[#3CB371]" />
//         <div className="absolute bottom-[-10px] right-[-8px] w-4 h-4 bg-[#3CB371]" />

//         {/* Connecting border lines */}
//         <div className="absolute top-0 left-4 right-4 bg-[#3CB371]" />
//         <div className="absolute bottom-0 left-4 right-4 bg-[#3CB371]" />
//         <div className="absolute left-0 top-4 bottom-4 bg-[#3CB371]" />
//         <div className="absolute right-0 top-4 bottom-4 bg-[#3CB371]" />
...
//               <div className="w-6 h-6 rounded-full bg-[#6366F1] border-2 border-white" />
...
//               className="absolute -left-18 top-2/4 lg:-left-26 md:-left-26 md:top-2/4 sm:-left-16 sm:top-3/4"
//             >
//               <svg
//                 width="19"
//                 height="19"
...
//               <h1 className="text-4xl md:text-5xl lg:text-6xl font-outfit font-bold text-[#111827] leading-tight">
//                 Designing the Future, <span className="text-green-600">One Pixel & Line of Code</span> at a Time!
//               </h1>
//             </div>
...
//               animate={{ y: [0, -10, 0] }}
//               transition={{ repeat: Infinity, duration: 2, ease: "easeInOut" }} 
//               className="absolute -right-18 top-2/4 lg:-right-26 md:-right-26 md:top-2/4 sm:-right-16 sm:top-3/4"
//             >
//               {/* Similar structure as first badge */}
//             </motion.div>
//           </div>
...
//               animate={{ y: [0, -10, 0] }}
//               transition={{ repeat: Infinity, duration: 2, ease: "easeInOut" }} 
//               className="absolute -right-16 lg:-right-20 top-1/2 transform lg:translate-y-8 md:translate-y-6 sm:translate-y-6 lg:translate-x-5 translate-y-8"
//             >
//               {/* Similar structure as other badges */}
//             </motion.div>
//           </div>
//         </div>
//       </div>
        ...
        <div className="relative w-full flex items-center justify-center px-4 py-20 bg-[#F6FFF7]">
            ...
            <div className="relative container mx-auto  max-w-5xl md:px-36 md:py-20 p-20 border border-[#3CB371] flex flex-col items-center text-center">
                ...
                <div className="max-w-3xl w-full flex flex-col items-center text-center relative z-10">
                    ...
                    <div className="flex items-center bg-white border border-gray-200 rounded-full px-4 py-2 mb-8 md:mb-12">
                        <div className="flex -space-x-2 mr-2">
                            <div className="w-6 h-6 rounded-full bg-[#6366F1] border-2 border-white"></div>
                    ...
                    <div className="relative mb-12 md:mb-16">
                        ...
                        <div className="text-center">
                            {/* <TextGenerateEffect
                words="Designing the Future, One Pixel & Line of Code at a Time!"
                as="h1"
