...
const Servicessection = () => {
  ...
  return (
    <section className='min-h-[120rem] w-full bg-[#f6fff7] p-5 space-y-5'>
      <div className='flex flex-col justify-center items-center sticky top-10'>
        <h1 className='text-green-600 text-lg font-semibold'>Our Services</h1>
        <h1>Description</h1>
      </div>

        {servicescontent.map((service) => (
        <div key={service.id} className='w-11/12 mx-auto min-h-[30rem] sticky top-32 bg-white border '>
          ...
          <div className='min-h-[30rem] p-10 w-2/3 space-y-3'>
            ...
            <div className='ml-20 w-80 h-52 rounded-2xl border-2 bg-white '>
            </div>
            <div className='flex justify-start items-center gap-96'>
              ...
              <motion.div animate={{ y: [0, -10, 0] }}
                ...
                <div className="bg-gradient-to-b from-green-500 text-center to-green-300 text-white text-xs md:text-sm font-medium  mt-10 place-content-center py-2 rounded-full flex items-center">
                  Learn More
                </div>
              </motion.div>
            </div>
