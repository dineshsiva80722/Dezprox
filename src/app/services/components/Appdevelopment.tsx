      ...
      <div className="container mx-auto">
        ...
        >
          ...
          <div className="w-full md:w-1/2">
            ...
            >
              The App Development service is designed for businesses and individuals who need modern, responsive, and high-performance mobile applications tailored to their needs.
            </motion.p>
            ...
            >
              ...
              <div className="flex items-start">
                ...
                <span>App Redesign & Optimization</span>
              </div>
              <div className="flex items-start">
                <div className="text-green-500 mr-2 mt-1">
                  <IconCheck />
                </div>
                <span>Enterprise App Solutions</span>
              </div>
              <div className="flex items-start">
                <div className="text-green-500 mr-2 mt-1">
                  <IconCheck />
                </div>
                <span>Mobile E-Commerce Solutions</span>
              </div>
            </motion.div>
          ...
          >
            <div className="bg-gray-200 rounded-lg h-full min-h-[400px]">
              <Image
                src="https://res.cloudinary.com/do7dw5dwq/image/upload/v1744023907/Appdevelopment_kzzfix.png"
                alt="App Development"
                width={400}
                height={400}
